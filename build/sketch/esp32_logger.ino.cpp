#include <Arduino.h>
#line 1 "/Users/shin/Documents/Arduino/esp32_logger/esp32_logger.ino"
...
hw_timer_t * timer = NULL; //timer初期化

SSD1306  display(0x3c, 21, 22); //SSD1306インスタンスの作成（I2Cアドレス,SDA,SCL）

WebServer webServer(80);
WebSocketsServer webSocket = WebSocketsServer(81);
const char SENSOR_JSON[] PROGMEM = R"=====({"voltage":%.1f,"current":%.1f,"power":%.1f})=====";

//タイマー割り込みで実行される関数です
#line 53 "/Users/shin/Documents/Arduino/esp32_logger/esp32_logger.ino"
void setup();
#line 118 "/Users/shin/Documents/Arduino/esp32_logger/esp32_logger.ino"
void loop();
#line 150 "/Users/shin/Documents/Arduino/esp32_logger/esp32_logger.ino"
void sdWrite(String msg);
#line 166 "/Users/shin/Documents/Arduino/esp32_logger/esp32_logger.ino"
String getCsvMessage();
#line 172 "/Users/shin/Documents/Arduino/esp32_logger/esp32_logger.ino"
float getVoltage();
#line 184 "/Users/shin/Documents/Arduino/esp32_logger/esp32_logger.ino"
float getCurrent();
#line 196 "/Users/shin/Documents/Arduino/esp32_logger/esp32_logger.ino"
String getLogTime();
#line 216 "/Users/shin/Documents/Arduino/esp32_logger/esp32_logger.ino"
bool checkSwitch(int switch_num);
#line 227 "/Users/shin/Documents/Arduino/esp32_logger/esp32_logger.ino"
void drawScreen();
#line 240 "/Users/shin/Documents/Arduino/esp32_logger/esp32_logger.ino"
void broadcastWeb();
#line 249 "/Users/shin/Documents/Arduino/esp32_logger/esp32_logger.ino"
void handleRoot();
#line 253 "/Users/shin/Documents/Arduino/esp32_logger/esp32_logger.ino"
void handleNotFound();
#line 48 "/Users/shin/Documents/Arduino/esp32_logger/esp32_logger.ino"
...
float getVoltage() {
    ...
    for(int i = 0; i < AVERAGENUM; i++) {
        ...
        voltage_tmp = voltage_tmp + read_from_ads / AVERAGENUM; //読んだ値を足していく：AVERAGENUMで割ることで平均化している
...
float getCurrent() {
    ...
    for(int i = 0; i < AVERAGENUM; i++) {
        ...
        current_tmp = current_tmp + read_from_ads / AVERAGENUM; //読んだ値を足していく：AVERAGENUMで割ることで平均化している
...
void broadcastWeb() {
    ...
    snprintf_P(payload, sizeof(payload), SENSOR_JSON, voltage, current, power);
